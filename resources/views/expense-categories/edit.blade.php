...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600">Update expense category details</p>
        </div>
        ...
        <form method="POST" action="{{ route('expense-categories.update', $expenseCategory) }}">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $expenseCategory->name) }}" required
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                              ...
                              placeholder="Enter category description">{{ old('description', $expenseCategory->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" id="color" name="color" value="{{ old('color', $expenseCategory->color) }}" required
                        ...
                        <div class="flex-1">
                            <input type="text" placeholder="#3B82F6" value="{{ old('color', $expenseCategory->color) }}"
