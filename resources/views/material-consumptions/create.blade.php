...
@section('title', 'Record Material Consumption')
...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Record Material Consumption</h1>
            <p class="text-gray-600">Track material usage and consumption across projects</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('material-consumptions.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="material_request_id" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('material_request_id') border-red-500 @enderror">
                            ...
                            @foreach(\App\Models\MaterialRequest::where('status', 'approved')->get() as $request)
                                <option value="{{ $request->id }}" {{ old('material_request_id') == $request->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="activity_type" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('activity_type') border-red-500 @enderror">
                            ...
                            <option value="installation" {{ old('activity_type') == 'installation' ? 'selected' : '' }}>Installation</option>
                            <option value="maintenance" {{ old('activity_type') == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                            <option value="repair" {{ old('activity_type') == 'repair' ? 'selected' : '' }}>Repair</option>
                            <option value="testing" {{ old('activity_type') == 'testing' ? 'selected' : '' }}>Testing</option>
                            <option value="demo" {{ old('activity_type') == 'demo' ? 'selected' : '' }}>Demo</option>
                    ...
                    <div>
                        ...
                        <select name="work_phase" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('work_phase') border-red-500 @enderror">
                            ...
                            <option value="preparation" {{ old('work_phase') == 'preparation' ? 'selected' : '' }}>Preparation</option>
                            <option value="foundation" {{ old('work_phase') == 'foundation' ? 'selected' : '' }}>Foundation</option>
                            <option value="structure" {{ old('work_phase') == 'structure' ? 'selected' : '' }}>Structure</option>
                            <option value="electrical" {{ old('work_phase') == 'electrical' ? 'selected' : '' }}>Electrical</option>
                            <option value="commissioning" {{ old('work_phase') == 'commissioning' ? 'selected' : '' }}>Commissioning</option>
                            <option value="maintenance" {{ old('work_phase') == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                            <option value="other" {{ old('work_phase') == 'other' ? 'selected' : '' }}>Other</option>
                        </select>
                        @error('work_phase')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="work_location" value="{{ old('work_location') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('work_location') border-red-500 @enderror" placeholder="e.g., Site A, Building B, Floor 2">
                        @error('work_location')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="quantity_consumed" value="{{ old('quantity_consumed') }}" min="1" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('quantity_consumed') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="unit_of_measurement" value="{{ old('unit_of_measurement') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('unit_of_measurement') border-red-500 @enderror" placeholder="e.g., pieces, kg, meters">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="consumption_percentage" value="{{ old('consumption_percentage', 90) }}" min="0" max="100" step="0.1" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('consumption_percentage') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" name="wastage_percentage" value="{{ old('wastage_percentage', 10) }}" min="0" max="100" step="0.1" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('wastage_percentage') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" name="return_percentage" value="{{ old('return_percentage', 0) }}" min="0" max="100" step="0.1" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('return_percentage') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="unit_cost" value="{{ old('unit_cost') }}" step="0.01" min="0" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('unit_cost') border-red-500 @enderror" placeholder="0.00">
                        @error('unit_cost')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="cost_center" value="{{ old('cost_center') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('cost_center') border-red-500 @enderror" placeholder="e.g., Project A, Department B">
                        @error('cost_center')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="quality_status" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('quality_status') border-red-500 @enderror">
                                ...
                                <option value="good" {{ old('quality_status', 'good') == 'good' ? 'selected' : '' }}>Good</option>
                                <option value="damaged" {{ old('quality_status') == 'damaged' ? 'selected' : '' }}>Damaged</option>
                                <option value="defective" {{ old('quality_status') == 'defective' ? 'selected' : '' }}>Defective</option>
                                <option value="expired" {{ old('quality_status') == 'expired' ? 'selected' : '' }}>Expired</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="consumption_status" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('consumption_status') border-red-500 @enderror">
                                ...
                                <option value="draft" {{ old('consumption_status') == 'draft' ? 'selected' : '' }}>Draft</option>
                                <option value="in_progress" {{ old('consumption_status', 'in_progress') == 'in_progress' ? 'selected' : '' }}>In Progress</option>
                                <option value="completed" {{ old('consumption_status') == 'completed' ? 'selected' : '' }}>Completed</option>
                                <option value="partial" {{ old('consumption_status') == 'partial' ? 'selected' : '' }}>Partial</option>
                                <option value="damaged" {{ old('consumption_status') == 'damaged' ? 'selected' : '' }}>Damaged</option>
                                <option value="returned" {{ old('consumption_status') == 'returned' ? 'selected' : '' }}>Returned</option>
                            </select>
                    ...
                    <div>
                        ...
                        <input type="date" name="consumption_date" value="{{ old('consumption_date', now()->format('Y-m-d')) }}" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('consumption_date') border-red-500 @enderror">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="time" name="start_time" value="{{ old('start_time') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('start_time') border-red-500 @enderror">
                            @error('start_time')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="time" name="end_time" value="{{ old('end_time') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('end_time') border-red-500 @enderror">
                            @error('end_time')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="consumed_by" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('consumed_by') border-red-500 @enderror">
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ old('consumed_by', Auth::id()) == $user->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="supervised_by" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('supervised_by') border-red-500 @enderror">
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ old('supervised_by') == $user->id ? 'selected' : '' }}>
                                    {{ $user->name }} ({{ $user->designation }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="documentation_type" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('documentation_type') border-red-500 @enderror">
                            ...
                            <option value="receipt" {{ old('documentation_type') == 'receipt' ? 'selected' : '' }}>Receipt</option>
                            <option value="photo" {{ old('documentation_type') == 'photo' ? 'selected' : '' }}>Photo</option>
                            <option value="video" {{ old('documentation_type') == 'video' ? 'selected' : '' }}>Video</option>
                            <option value="report" {{ old('documentation_type') == 'report' ? 'selected' : '' }}>Report</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="documentation_path" value="{{ old('documentation_path') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('documentation_path') border-red-500 @enderror" placeholder="File path or URL">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('notes') border-red-500 @enderror" placeholder="Additional notes or observations...">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="quality_observations" rows="3" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('quality_observations') border-red-500 @enderror" placeholder="Quality observations and any issues noted...">{{ old('quality_observations') }}</textarea>
            ...
            <div class="mt-8 bg-gray-50 p-6 rounded-lg">
                <div class="flex justify-center space-x-4">
                    <a href="{{ route('material-consumptions.index') }}" 
